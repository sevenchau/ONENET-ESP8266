...
#define  APP_CFG_TASK_START_PRIO                           12u
#define  APP_CFG_TASK_EQ_PRIO                              14u
#define  APP_CFG_TASK_NET_PRIO                             13u
...
extern uint8_t GetGaspMsg(uint8_t gasp[2]);
extern uint8_t GetBrightnessMsg(uint8_t brightness[2]);
extern uint8_t GetHumitureMsg(uint8_t humidity[2], uint8_t temperature[2]);

extern void AppObjCreate          (void);
extern void AppDataAcqCreate      (void);
